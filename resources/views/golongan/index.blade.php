...
<div class="container">
    ...
    <a href="{{ url('/golongan/create') }}">
        <button class="btn-sm mb-3" style="box-shadow: 12px 12px 5px rgba(0, 0, 255, .2);">Tambah Golongan</button>
    </a>
    <table class="table table-bordered" style="box-shadow: 12px 12px 5px rgba(0, 0, 255, .2); border: solid 2px black;">
        ...
        <tr style="background-color: pink; color: black; text-align: center;">
            ...
            <td>{{ $row->gol_nama }}</td>
            <td>
                <a href="{{ url('golongan/' . $row->gol_id . '/edit') }}">
